...
function validFailureCause(value: unknown): value is FailureCauseV1 {
  return exact(value, ["class", "subtype", "certainty", "causeEventRefs", "affectedKnowledgeRefs"])
    ...
    && FAILURE_CERTAINTIES.includes(value.certainty as FailureCertaintyV1) && sortedUnique(value.causeEventRefs, eventRef, CKS_MAX_CAUSE_EVENT_REFS_V1) && sortedUnique(value.affectedKnowledgeRefs, knowledgeRef)
