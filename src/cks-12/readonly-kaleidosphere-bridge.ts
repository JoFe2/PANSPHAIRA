...
export function runReadOnlyMinimizedProjection(input: unknown): Candidate | Denied {
  ...
  return { status: "CANDIDATE_RECORDED", candidateId: `KS-CANDIDATE-${acceptedProjection.projectionId as string}`, candidateKind: "KALEIDOSPHERE_CANDIDATE", projectionSha256: digest(acceptedProjection), canonicalEvidenceSha256: input.canonicalEvidenceBeforeSha256 as string, inventedEdgeCount: 0, promotion: "NOT_AUTHORIZED", authority: "NONE", capabilityDelta: "NONE", effect: "NONE", executionClaimed: false, productionClaimed: false };
}
